...
namespace Tangram.Data
{
    class Database
    {
        ...
        static public DataTable users = new DataTable();

        static public int subGroupCount = 0;
        static public DataTable groups = new DataTable();

        static public DataTable children = new DataTable();
        static public DataTable childrenInClass = new DataTable();

        static public DataTable figures = new DataTable();
